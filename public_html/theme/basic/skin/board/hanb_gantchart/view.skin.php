...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con">
            <table class="proj_info">
                <tr>
                    <th>상품번호</th><td><?php echo $view['wr_subject']; ?></td>
                </tr>
                <tr>
                    <th>투자금액</th><td><?php echo L_nf($view['content'],",원"); ?></td>
                </tr>
                <tr>
                    <th>연수익</th><td><?php echo $view['wr_3']; ?> %</td>
                </tr>
                <tr>
                    <th>수수료</th><td><?php echo $view['wr_4']; ?> %</td>
                </tr>
                <tr>
                    <th>소득세</th><td><?php echo $view['wr_5']; ?> %</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>대출자</th><td><?php echo $view['wr_10']; ?></td>
                </tr>
                <tr>
                    <th>프로젝트 기간</th><td><?php echo $view['wr_1']; ?> ~ <?php echo $view['wr_2']; ?></td>
                </tr>
                <tr <?=($view['wr_8']=="")?"style='display:none'":"";?>>
                    <th>중도상환</th><td><?php echo $view['wr_8']; ?></td>
                </tr>
            </table>
