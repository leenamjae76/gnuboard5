...
<div id="hd">
    ...
    <nav id="gnb">
        ...
        <div class="gnb_wrap">
            <ul id="gnb_1dul">
				<?php if ($is_member) {  ?>
				<li class="gnb_1dli" style="display: block; font-weight: bold; padding: 0 15px; color: #080808; text-decoration: none;"><a href="<?php echo G5_BBS_URL ?>/logout.php">LogOut</a></li>
				<?php if ($is_admin) {  ?>
				<li class="gnb_1dli" style="display: block; font-weight: bold; padding: 0 15px; color: #080808; text-decoration: none;"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">Admin</a></li>
				<?php }  ?>
				<?php } else {  ?>
				<li class="gnb_1dli" style="display: block; font-weight: bold; padding: 0 15px; color: #080808; text-decoration: none;"><a href="<?php echo G5_BBS_URL ?>/login.php">LogIn</a></li>
				<?php }  ?>
